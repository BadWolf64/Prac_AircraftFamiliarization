...
class Ship_F {};
class Soldier_F {
  uniform[] = {"CUP_U_B_BAF_DPM_S2_UnRolled","CUP_U_B_BAF_DPM_S1_RolledUp"};
  vest[] = {"CUP_V_BAF_Osprey_Mk2_DPM_Soldier1","CUP_V_BAF_Osprey_Mk2_DPM_Soldier2"};
  headgear[] = {"CUP_H_BAF_Helmet_1_DPM","CUP_H_BAF_Helmet_3_DPM"};
